...
/***/ "./src/services/gemini-api/gemini-service.ts":
/*!***************************************************!*\
  !*** ./src/services/gemini-api/gemini-service.ts ***!
  \***************************************************/
...
/*!**************************************!*\
  ...
  \**************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_gemini_api_gemini_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/gemini-api/gemini-service */ "./src/services/gemini-api/gemini-service.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
chrome.runtime.onInstalled.addListener((details) => {
    ...
    const initializeStorage = () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e, _f;
        const defaults = yield chrome.storage.local.get(['apiKey', 'contentPreferences', 'userSettings']);
        yield chrome.storage.local.set({
            apiKey: defaults.apiKey || '',
            contentPreferences: {
                tone: ((_a = defaults.contentPreferences) === null || _a === void 0 ? void 0 : _a.tone) || 'professional',
                length: ((_b = defaults.contentPreferences) === null || _b === void 0 ? void 0 : _b.length) || 'medium',
                topics: ((_c = defaults.contentPreferences) === null || _c === void 0 ? void 0 : _c.topics) || []
            },
            userSettings: {
                autoDraft: ((_d = defaults.userSettings) === null || _d === void 0 ? void 0 : _d.autoDraft) || false,
                clipboardIntegration: (_f = (_e = defaults.userSettings) === null || _e === void 0 ? void 0 : _e.clipboardIntegration) !== null && _f !== void 0 ? _f : true,
                validation: {
                    minPostLength: 100,
                    maxHashtags: 5
                }
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    ...
    if (request.type === 'generateContent') {
        const geminiService = _services_gemini_api_gemini_service__WEBPACK_IMPORTED_MODULE_0__.GeminiService.getInstance();
